...
sudo wget -4 -O lk_ipv4.txt 'https://raw.githubusercontent.com/ndevxlk/lk-only/main/lk_ipv4.txt' > /dev/null 2>&1
sudo wget -4 -O lk_ipv6.txt 'https://raw.githubusercontent.com/ndevxlk/lk-only/main/lk_ipv6.txt' > /dev/null 2>&1
